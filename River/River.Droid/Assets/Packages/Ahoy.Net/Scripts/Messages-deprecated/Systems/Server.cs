...
//         {
//             // var driver = new GenericNetworkDriver<
//             if (debug)
//                 Debug.Log($"server - initializing on port {port}");
//             Dispose();
//             isInitialized = true;
...
//             {
//                 if (debug) Debug.Log($"server - Failed to bind to port {port}");
//             }
//             else
//             {
...
//         {
//             if (debug)
//                 Debug.Log($"server - sending message: {msg}");
//             connections.ForEach(c => Messaging.WriteMessage(msg, writer => driver.Send(NetworkPipeline.Null, c, writer)));
//         }
