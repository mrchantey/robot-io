...
namespace Ahoy.Net
{
    ...
    public static class Messaging
    {
        ...
        public static object ReadMessage(DataStreamReader stream)
        {
        ...
        public static void WriteMessage(object data, Action<DataStreamWriter> sendCallback)
        {
            var bytes = ObjectToBytes(data);
